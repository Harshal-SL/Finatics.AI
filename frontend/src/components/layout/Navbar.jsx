...
export function Navbar({ items, className, showLogo = true }) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed top-0 left-1/2 -translate-x-1/2 pt-6 z-[9999]",
          className,
        )}
      >
        <div className="flex items-center gap-3 bg-card/80 border border-border backdrop-blur-xl py-1 px-1 rounded-full shadow-lg">
          {items.map((item) => {
