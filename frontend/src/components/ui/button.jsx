...
const buttonVariants = cva(
    "relative group border mx-auto text-center rounded-full",
    {
        variants: {
            variant: {
                default: "bg-blue-500/5 hover:bg-blue-500/0 border-blue-500/20 text-blue-500",
                solid: "bg-black hover:bg-black/90 text-blue-500 border-blue-500/50 hover:border-blue-500 transition-all duration-200",
                ghost: "border-transparent bg-transparent hover:border-zinc-600 hover:bg-white/10 text-foreground",
            },
            size: {
                default: "px-7 py-1.5 ",
                sm: "px-4 py-0.5 ",
