...
const { initializeCacheService } = require('./services/marketDataCacheService');
 ...
 * WITH OPTIMIZED MARKET DATA CACHING (reduces API calls by 98%)
 */
...
const server = app.listen(port, () => {
  ...
  // Initialize market data cache service (auto-refreshes every 30 min)
