# PowerShell script to test loan analyzer endpoint
# This script starts the backend server and tests the loan analyzer endpoint

Write-Host ("=" * 70) -ForegroundColor Cyan
Write-Host "Loan Analyzer Endpoint Test Setup" -ForegroundColor Cyan
Write-Host ("=" * 70) -ForegroundColor Cyan
Write-Host ""
...
Write-Host ("=" * 70) -ForegroundColor Cyan
Write-Host "Running Loan Analyzer Test" -ForegroundColor Cyan
Write-Host ("=" * 70) -ForegroundColor Cyan
Write-Host ""

# Run the test
Set-Location "e:\Code\Finatics.AI\BackEnd"
node test/test_loan_analyzer_endpoint.js
